...
ENC28J60=lib/enc28j60/enc28j60.c lib/enc28j60/enc28j60_driver.c
...
CFLAGS=-mcpu=cortex-m3 -mthumb -mlittle-endian -mthumb-interwork -T lib/ld/stm32_flash.ld -DUSE_STDPERIPH_DRIVER -DSTM32F10X_$(SYS) -DHSE_VALUE=$(HSE) -Ilib/inc -Ilib/enc28j60 -lnosys -nostdlib -Os
